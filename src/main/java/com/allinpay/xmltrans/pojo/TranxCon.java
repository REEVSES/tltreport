...
public class TranxCon {
	 ...
	 * XML交易参数
	 */
	public   String acctName = "test";
	public   String acctNo = "6225882516636351";
	public   String amount = "100000";//交易金额
	public   String bankcode = "0105";//银行代码
	public   String cerPath= "target\\uploadP12\\20060400000538204.cer";
	public   String merchantId = "200604000005382";                 //商户号：200604000000445
	public   String password = "111111";
	//商户证书信息
/*	public   String pfxPassword = "111111";
	public   String pfxPath= "config\\20060400000124704.p12";
	public   String sum = "200000";//交易总金额
	public   String tel = "13434343434";
	public   String tltcerPath= "config\\allinpay-pds.cer";
	public   String userName = "20060400000124704"; */
	
	public   String pfxPassword = "111111";
	public   String pfxPath= "target\\uploadP12\\20060400000538204.p12";
	public   String sum = "200000";//交易总金额
	public   String tel = "13434343434";
	public   String tltcerPath= "target\\uploadCer\\allinpay-pds.cer";
	public   String userName = "20060400000538204";
